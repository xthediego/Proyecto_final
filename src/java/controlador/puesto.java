...
public class puesto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title> Puesto </title>");            
            out.println("</head>");
            out.println("<body>");
            
       // *******************     out.println("<h1> funcionando serveleth</h1>");
           // out.println("<p>"+  request.getParameter("id") +"</p>");
            //out.println("<p>"+  request.getParameter("txt_puesto") +"</p>");
            
            puestos p = new puestos(Integer.parseInt(request.getParameter("txt_id")),request.getParameter("txt_puesto") );
